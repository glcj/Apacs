 ...
 * @author cgarcia
 */
public class JDataTagListMultiThreadRuntime3Test extends TestCase {
            ...
            do {
                ...
                if (EC != Japx.ER_Success) {
                    try {
                        ...
                        Logger.getLogger(JDataTagListMultiThreadRuntime3Test.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
   ...
   /**
    ...
    public void testPruebaDeTareas()  {
        ...
        DTL2DT2 = Japxapi.AddDataTag(DTL2, "RESPALDO_IP.RESOURCE_BLOCKS.RESOURCE_STATUS.PCTCOM");
        assertNotNull("No se pudo crear RESPALDO_IP.RESOURCE_BLOCKS.RESOURCE_STATUS.PCTCOM", DTL2DT2);
