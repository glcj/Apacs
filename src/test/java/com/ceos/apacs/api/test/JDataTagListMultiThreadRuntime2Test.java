 ...
 * @author cgarcia
 */
public class JDataTagListMultiThreadRuntime2Test extends TestCase {

    public static Pointer DTL1,DTL2;
    public static Pointer DTL1DT1, DTL1DT2, DTL1DT3 ,DTL1DT4;
    public static Pointer DTL2DT1, DTL2DT2, DTL2DT3 ,DTL2DT4;
            ...
            do {
                ...
                if (EC != Japx.ER_Success) {
                    try {
                        ...
                        Logger.getLogger(JDataTagListMultiThreadRuntime2Test.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
   ...
   /**
    ...
    public void testPruebaDeTareas()  {
        ...
        DTL1DT1 = Japxapi.AddDataTag(DTL1, "RESPALDO_IP.RESOURCE_BLOCKS.RESOURCE_STATUS.PROG_T");
        ...
        DTL2DT2 = Japxapi.AddDataTag(DTL2, "RESPALDO_IP.RESOURCE_BLOCKS.ERROR_LOG.CLASS");
        assertNotNull("No se pudo crear RESPALDO_IP.RESOURCE_BLOCKS.ERROR_LOG.CLASS", DTL2DT2);
        DTL2DT3 = Japxapi.AddDataTag(DTL2, "RESPALDO_IP.RESOURCE_BLOCKS.ERROR_LOG.NEW_ER");
        assertNotNull("No se pudo crear RESPALDO_IP.RESOURCE_BLOCKS.ERROR_LOG.NEW_ER", DTL2DT3);
        DTL2DT4 = Japxapi.AddDataTag(DTL2, "RESPALDO_IP.RESOURCE_BLOCKS.RESOURCE_STATUS.WFLAG");
        assertNotNull("No se pudo crear RESPALDO_IP.RESOURCE_BLOCKS.RESOURCE_STATUS.WFLAG",DTL2DT4);
